...
using Files.API.DTOs;
using Files.Application;
using Files.Application.Files.Commands.CreateFile;
using Files.Application.Files.DTOs;
using Files.Application.Files.Queries.GetFileContent;
using Files.Application.Files.Queries.GetFileMetadata;
using Files.Application.Files.Queries.ListFileMetadata;
...
public class FilesController : ApiControllerBase
{
    ...
    public async Task<IActionResult> ListFileMetadata([FromQuery] PaginationFilter paginationFilter, [FromQuery] IEnumerable<FileId> ids)
    {
